...
ENDIF()
if (HDF5_LIB_DIR)
  find_library(HDF5_LIB_HDF5_CPP     libhdf5_cpp   ${HDF5_LIB_DIR} NO_DEFAULT_PATH)
  find_library(HDF5_LIB_HDF5_C       libhdf5       ${HDF5_LIB_DIR} NO_DEFAULT_PATH)
  find_library(HDF5_LIB_SZIP         libszip       ${HDF5_LIB_DIR} NO_DEFAULT_PATH)
  find_library(HDF5_LIB_ZLIB         libzlib       ${HDF5_LIB_DIR} NO_DEFAULT_PATH)

  find_library(HDF5_LIB_HDF5_CPP_D    libhdf5_cpp_D   ${HDF5_LIB_DIR} NO_DEFAULT_PATH)
  find_library(HDF5_LIB_HDF5_C_D      libhdf5_D       ${HDF5_LIB_DIR} NO_DEFAULT_PATH)
  find_library(HDF5_LIB_SZIP_D        libszip_D       ${HDF5_LIB_DIR} NO_DEFAULT_PATH)
  find_library(HDF5_LIB_ZLIB_D        libzlib_D       ${HDF5_LIB_DIR} NO_DEFAULT_PATH)
