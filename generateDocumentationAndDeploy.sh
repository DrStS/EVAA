...
if [ -d "html" ] && [ -f "html/index.html" ]; then
    ...
    git commit --amend -m "Deploy code docs to GitHub Pages Travis build: ${TRAVIS_BUILD_NUMBER}" -m "Commit: ${TRAVIS_COMMIT}"
