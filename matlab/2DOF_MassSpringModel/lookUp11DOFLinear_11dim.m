...
w_min = -1;
w_max = 1;
w_domain = w_min:dw:w_max;
length_domain = l_min : dl : l_max;
...
% x - length(1, 4:11); angular velocity x(2:3)
[X1,X2,X3,X4,X5,X6,X7,X8,X9,X10,X11] = ndgrid(length_domain, ...
                                              w_domain, ...
                                              w_domain, ...
                                              length_domain, ...
                                              length_domain, ...
...
function K = get_K(x)
    ...
    k_body_fl=interp3(X,Y,Z,k_grid,x(2),long_fl,x(3));
    k_tyre_fl=interp3(X,Y,Z,k_grid,x(2),lat_fl,x(3));
    k_body_fr=interp3(X,Y,Z,k_grid,x(2),long_fr,x(3));
    k_tyre_fr=interp3(X,Y,Z,k_grid,x(2),lat_fr,x(3));
    k_body_rl=interp3(X,Y,Z,k_grid,x(2),long_rl,x(3));
    k_tyre_rl=interp3(X,Y,Z,k_grid,x(2),lat_rl,x(3));
    k_body_rr=interp3(X,Y,Z,k_grid,x(2),long_rr,x(3));
    k_tyre_rr=interp3(X,Y,Z,k_grid,x(2),lat_rr,x(3));
