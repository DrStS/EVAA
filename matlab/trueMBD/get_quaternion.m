...
%   -one returns only the quaternion (remove the postprocessing)
%   -one returns only angle+axis (remove all parts that involve q)
...
%% verify if the rotation is correct (this might be quite expensive)
...
%% postprocessing for the axis from the rotational spring0
