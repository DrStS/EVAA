...
QMouseEvent *QVTKFramebufferObjectItem::getLastMoveEvent() { return m_lastMouseMove.get(); }

QWheelEvent *QVTKFramebufferObjectItem::getLastWheelEvent() { return m_lastMouseWheel.get(); }
...
bool QVTKFramebufferObjectItem::getGourauInterpolation() const { return m_gouraudInterpolation; }

int QVTKFramebufferObjectItem::getModelColorR() const { return m_modelColorR; }

int QVTKFramebufferObjectItem::getModelColorG() const { return m_modelColorG; }

int QVTKFramebufferObjectItem::getModelColorB() const { return m_modelColorB; }
...
bool QVTKFramebufferObjectItem::isCommandsQueueEmpty() const { return m_commandsQueue.empty(); }
