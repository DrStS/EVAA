...
public:
	...
	////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	// DAXPY and SAXPY
	static void axpy(const MKL_INT n, const T a, const T *x, const MKL_INT incx, T *y, const MKL_INT incy) {
	...
	// DROT and SROT
	static void rot(const MKL_INT n, T *x, const MKL_INT incx, T *y, const MKL_INT incy, const T c, const T s) {
#ifdef SINGLE_PRECISION
	...
	static void gbmv(const CBLAS_LAYOUT Layout, const CBLAS_TRANSPOSE trans, const MKL_INT m, const MKL_INT n,
		const MKL_INT kl, const MKL_INT ku, const T alpha, const T *a,
	...
	static void ger(const CBLAS_LAYOUT Layout, const MKL_INT m, const MKL_INT n,
		const T alpha, const T *x, const MKL_INT incx, const T *y,
		const MKL_INT incy, T *a, const MKL_INT lda) {
#ifdef SINGLE_PRECISION
	...
	static void sbmv(const CBLAS_LAYOUT Layout, const CBLAS_UPLO uplo, const MKL_INT n, const MKL_INT k, 
	...
	static void syr2(const CBLAS_LAYOUT Layout, const CBLAS_UPLO uplo, const MKL_INT n,
		const T alpha, const T *x, const MKL_INT incx,
		const T *y, const MKL_INT incy, T *a, const MKL_INT lda) {
#ifdef SINGLE_PRECISION
	...
	static void gemm(const CBLAS_LAYOUT Layout, const CBLAS_TRANSPOSE transa, const CBLAS_TRANSPOSE transb, const MKL_INT m, 
		const MKL_INT n, const MKL_INT k, const T alpha, const T *a, const MKL_INT lda, const T *b, const MKL_INT ldb, 
	...
	static void symm(const CBLAS_LAYOUT Layout, const CBLAS_SIDE side, const CBLAS_UPLO uplo, const MKL_INT m, const MKL_INT n, 
	...
	static void trmm(const CBLAS_LAYOUT Layout, const CBLAS_SIDE side, const CBLAS_UPLO uplo, const CBLAS_TRANSPOSE transa, 
		const CBLAS_DIAG diag, const MKL_INT m, const MKL_INT n, const T alpha, 
		const T *a, const MKL_INT lda, T *b, const MKL_INT ldb) {
#ifdef SINGLE_PRECISION
	...
	static lapack_int getrf(int matrix_layout, lapack_int m, lapack_int n, T * a, lapack_int lda, lapack_int * ipiv) {
	...
	static lapack_int getrs(int matrix_layout, char trans, lapack_int n, lapack_int nrhs, const T* a, lapack_int lda, const lapack_int * ipiv, T* b, lapack_int ldb) {
	...
	static lapack_int gecon(int matrix_layout, char norm, lapack_int n, const T* a, lapack_int lda, T anorm, T* rcond) {
#ifdef SINGLE_PRECISION
	...
	static lapack_int gbtrf(int matrix_layout, lapack_int m, lapack_int n, lapack_int kl, lapack_int ku, T* ab, lapack_int ldab, lapack_int * ipiv) {
#ifdef SINGLE_PRECISION
	...
	static lapack_int gbtrs(int matrix_layout, char trans, lapack_int n, lapack_int kl, lapack_int ku, lapack_int nrhs, const T* ab, lapack_int ldab, const lapack_int * ipiv, T* b, lapack_int ldb) {
#ifdef SINGLE_PRECISION
	...
	static lapack_int gbcon(int matrix_layout, char norm, lapack_int n, lapack_int kl, lapack_int ku, const T* ab, lapack_int ldab, const lapack_int* ipiv, T anorm, T* rcond) {
#ifdef SINGLE_PRECISION
	...
	static lapack_int potrs(int matrix_layout, char uplo, lapack_int n, lapack_int nrhs, const T* a, lapack_int lda, T* b, lapack_int ldb) {
#ifdef SINGLE_PRECISION
	...
	static lapack_int pocon(int matrix_layout, char uplo, lapack_int n, const T* a, lapack_int lda, T anorm, T* rcond) {
#ifdef SINGLE_PRECISION
	...
	static lapack_int pttrs(int matrix_layout, lapack_int n, lapack_int nrhs, const T* d, const T* e, T* b, lapack_int ldb) {
#ifdef SINGLE_PRECISION
	...
	static lapack_int geqrf(int matrix_layout, lapack_int m, lapack_int n, T* a, lapack_int lda, T* tau) {
#ifdef SINGLE_PRECISION
	...
	static lapack_int geqpf(int matrix_layout, lapack_int m, lapack_int n, T* a, lapack_int lda, lapack_int* jpvt, T* tau) {
#ifdef SINGLE_PRECISION
	...
	static lapack_int orgqr(int matrix_layout, lapack_int m, lapack_int n, lapack_int k, T* a, lapack_int lda, const T* tau) {
#ifdef SINGLE_PRECISION
	...
	static lapack_int ormqr(int matrix_layout, char side, char trans, lapack_int m, lapack_int n, lapack_int k, const T* a, lapack_int lda, const T* tau, T* c, lapack_int ldc) {
#ifdef SINGLE_PRECISION
	...
	static lapack_int gebrd(int matrix_layout, lapack_int m, lapack_int n, T* a, lapack_int lda, T* d, T* e, T* tauq, T* taup) {
#ifdef SINGLE_PRECISION
	...
	static lapack_int bdsqr(int matrix_layout, char uplo, lapack_int n, lapack_int ncvt, lapack_int nru, lapack_int ncc, T* d, T* e, T* vt, lapack_int ldvt, T* u, lapack_int ldu, T* c, lapack_int ldc) {
#ifdef SINGLE_PRECISION
	...
	static lapack_int bdsdc(int matrix_layout, char uplo, char compq, lapack_int n, T* d, T* e, T* u, lapack_int ldu, T* vt, lapack_int ldvt, T* q, lapack_int* iq) {
#ifdef SINGLE_PRECISION
	...
	static lapack_int sytrd(int matrix_layout, char uplo, lapack_int n, T* a, lapack_int lda, T* d, T* e, T* tau) {
#ifdef SINGLE_PRECISION
	...
	static lapack_int sbtrd(int matrix_layout, char vect, char uplo, lapack_int n, lapack_int kd, T* ab, lapack_int ldab, T* d, T* e, T* q, lapack_int ldq) {
#ifdef SINGLE_PRECISION
	...
	static lapack_int orgtr(int matrix_layout, char uplo, lapack_int n, T* a, lapack_int lda, const T* tau) {
#ifdef SINGLE_PRECISION
	...
	static lapack_int ormtr(int matrix_layout, char side, char uplo, char trans, lapack_int m, lapack_int n, const T* a, lapack_int lda, const T* tau, T* c, lapack_int ldc) {
#ifdef SINGLE_PRECISION
	...
	static lapack_int steqr(int matrix_layout, char compz, lapack_int n, T* d, T* e, T* z, lapack_int ldz) {
#ifdef SINGLE_PRECISION
	...
	static lapack_int stedc(int matrix_layout, char compz, lapack_int n, T* d, T* e, T* z, lapack_int ldz) {
#ifdef SINGLE_PRECISION
	...
	static lapack_int pteqr(int matrix_layout, char compz, lapack_int n, T* d, T* e, T* z, lapack_int ldz) {
#ifdef SINGLE_PRECISION
	...
	static lapack_int ggsvp(int matrix_layout, char jobu, char jobv, char jobq, 
		lapack_int m, lapack_int p, lapack_int n, T* a, lapack_int lda, T* b, 
		lapack_int ldb, T tola, T tolb, lapack_int* k, lapack_int* l, 
		T* u, lapack_int ldu, T* v, lapack_int ldv, T* q, lapack_int ldq) {
#ifdef SINGLE_PRECISION
		return LAPACKE_sggsvp(matrix_layout, jobu, jobv, jobq, m, p, n, a, lda, b, ldb, tola, tolb, k, l, u, ldu, v, ldv, q, ldq);
#elif DOUBLE_PRECISION
		return LAPACKE_dggsvp(matrix_layout, jobu, jobv, jobq, m, p, n, a, lda, b, ldb, tola, tolb, k, l, u, ldu, v, ldv, q, ldq);
#else
		mkl::mkl_error();
#endif
	}
	...
	static lapack_int ggsvp3(int matrix_layout, char jobu, char jobv, char jobq, lapack_int m, 
		lapack_int p, lapack_int n, T* a, lapack_int lda, T* b, lapack_int ldb, T tola, T tolb, 
		lapack_int * k, lapack_int * l, T* u, lapack_int ldu, T* v, lapack_int ldv, 
		T* q, lapack_int ldq) {
#ifdef SINGLE_PRECISION
		return LAPACKE_sggsvp3(matrix_layout, jobu, jobv, jobq, m, p, n, a, lda, b, ldb, tola, tolb, k, l, u, ldu, v, ldv, q, ldq);
#elif DOUBLE_PRECISION
		return LAPACKE_dggsvp3(matrix_layout, jobu, jobv, jobq, m, p, n, a, lda, b, ldb, tola, tolb, k, l, u, ldu, v, ldv, q, ldq);
#else
		mkl::mkl_error();
#endif
	}
	...
	static lapack_int ggsvd3(int matrix_layout, char jobu, char jobv, char jobq, lapack_int m, 
		lapack_int n, lapack_int p, lapack_int * k, lapack_int * l, T* a, lapack_int lda, 
		T* b, lapack_int ldb, T* alpha, T* beta, T* u, lapack_int ldu, 
		T* v, lapack_int ldv, T* q, lapack_int ldq, lapack_int * iwork) {
#ifdef SINGLE_PRECISION
		return LAPACKE_sggsvd3(matrix_layout, jobu, jobv, jobq, m, n, p, k, l, a, lda, b, ldb, alpha, beta, u, ldu, v, ldv, q, ldq, iwork);
#elif DOUBLE_PRECISION
		return LAPACKE_dggsvd3(matrix_layout, jobu, jobv, jobq, m, n, p, k, l, a, lda, b, ldb, alpha, beta, u, ldu, v, ldv, q, ldq, iwork);
#else
		mkl::mkl_error();
#endif
	}

	static lapack_int tgsja(int matrix_layout, char jobu, char jobv, char jobq, lapack_int m, lapack_int p, 
		lapack_int n, lapack_int k, lapack_int l, T* a, lapack_int lda, T* b, lapack_int ldb, T tola, T tolb, 
		T* alpha, T* beta, T* u, lapack_int ldu, T* v, lapack_int ldv, T* q, lapack_int ldq, lapack_int* ncycle) {
#ifdef SINGLE_PRECISION
	...
	static void vLinearFrac(const MKL_INT n, const T *a, const T *b, const T scalea, const T shifta, const T scaleb, const T shiftb, const T *y) {
#ifdef SINGLE_PRECISION
	...
	static int dfNewTask1D(DFTaskPtr* task, const MKL_INT nx, const T* x, const MKL_INT xhint, const MKL_INT ny, const T* y, const MKL_INT yhint) {
#ifdef SINGLE_PRECISION
	...
	static int dfEditPPSpline1D(DFTaskPtr task, const MKL_INT s_order, const MKL_INT s_type, const MKL_INT bc_type, 
		const T* bc, const MKL_INT ic_type, const T* ic, const T* scoeff, const MKL_INT scoeffhint) {
#ifdef SINGLE_PRECISION
		return dfsEditPPSpline1D(task, s_order, s_type, bc_type, bc, ic_type, ic, scoeff, scoeffhint);
#elif DOUBLE_PRECISION
		return dfdEditPPSpline1D(task, s_order, s_type, bc_type, bc, ic_type, ic, scoeff, scoeffhint);
#else
		mkl::mkl_error();
#endif
	}
	...
	static int dfInterpolate1D(DFTaskPtr task, const MKL_INT type, const MKL_INT method, 
		const MKL_INT nsite, const T* site, const MKL_INT sitehint, const MKL_INT ndorder, 
		const MKL_INT* dorder, const T* datahint, T* r, const MKL_INT rhint, MKL_INT* cell) {
#ifdef SINGLE_PRECISION
		return dfsInterpolate1D(task, type, method, nsite, site, sitehint, ndorder, dorder, datahint, r, rhint, cell);
#elif DOUBLE_PRECISION
		return dfdInterpolate1D(task, type, method, nsite, site, sitehint, ndorder, dorder, datahint, r, rhint, cell);
#else
		mkl::mkl_error();
#endif
	}
	...
	static int dfInterpolateEx1D(DFTaskPtr task, const MKL_INT type, const MKL_INT method,
		const MKL_INT nsite, const T* site, const MKL_INT sitehint, const MKL_INT ndorder,
		const MKL_INT* dorder, const T* datahint, T* r, const MKL_INT rhint, MKL_INT* cell, 
		const void* le_params, const void* re_params, const void* i_params, const void* search_params) {
		/*
		This needs modification to incorporate callbacks
		*/
#ifdef SINGLE_PRECISION
		return dfsInterpolateEx1D(task, type, method, nsite, site, sitehint, ndorder, dorder, datahint, r, rhint, cell, NULL, le_params, NULL, re_params, NULL, i_params, NULL, search_params);
#elif DOUBLE_PRECISION
		return dfdInterpolateEx1D(task, type, method, nsite, site, sitehint, ndorder, dorder, datahint, r, rhint, cell, NULL, le_params, NULL, re_params, NULL, i_params, NULL, search_params);
#else
		mkl::mkl_error();
#endif
	}
