...
void EVAAMainWindow::setModelColorR(const int colorR)
{
	m_vtkFboItem->setModelColorR(colorR);
}

void EVAAMainWindow::setModelColorG(const int colorG)
{
	m_vtkFboItem->setModelColorG(colorG);
}

void EVAAMainWindow::setModelColorB(const int colorB)
{
