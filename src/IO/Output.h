...
public:
     ...
     */
    void writeSoltionVector(T* solVec,    /**< of size Constants::VEC_DIM * Constants::DIM = 27 */
    ...
    void writeSolutionMatrix(T* solVec, /**< of size sol_size * Constants::VEC_DIM * Constants::DIM = 27 */
        ...
        for (auto i = 0; i < sol_size; i++) {
            writeSoltionVector(solVec + i * Constants::VEC_DIM * Constants::DIM, velVec + i * (Constants::DIM - 1) * Constants::VEC_DIM, angVec + i * Constants::DIM);
        }
    };
