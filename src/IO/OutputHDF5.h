 ...
 */
template <typename T>
void WriteVectorToFile(const std::string& fileName, const std::string& datasetName, T* vector, size_t size) {
    /*
 ...
 */
template <typename T>
void ReadVectorFromFile(const std::string& fileName, const std::string& datasetName, T* vector, size_t size) {
    /*
