...
public:
   ...
   * \param[in] t_inputFileName name of xml input file
   * \author Stefan Sicklinger
   **/
  EVAAComputeEngine(std::string t_inputFileName);
  /**
   * \brief Test hdf5 output demo write
   * \param[in] t_outputFileName name of hdf5 file
   * \author Stefan Sicklinger
   **/
  void testHDF5(const std::string &t_outputFileName);

public:
  /**
   * \brief name of xml input file
   **/
